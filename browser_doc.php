...
$browser[$i]->add_step(
new BrowserStep('step5','
安裝好之後,請先登入<a href="https://if163.aca.ntu.edu.tw/eportfolio/student/OpinionEnd.asp" target="_bank">ePo網頁</a>
',
'./img/c8.png'
)
);
